...
if( !class_exists( 'CPD_Meta_Box_Feedback' ) ) {
		...
		$metabox_args	= 	array(
								'fields' 	=> 	array(
													array( 
														...
														'desc'			=>	'The feedback for this assessment (can only be edited by a Supervisor). <strong>NOTE:</strong> Criteria for this assessment should be added in the \'Criteria\' section.',														'type'			=> 	'wysiwyg',
														'cols'			=> 	12,
													),
												)
							);
